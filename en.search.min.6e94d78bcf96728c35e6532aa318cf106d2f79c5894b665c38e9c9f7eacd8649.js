...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s-book/flexsearch.min.js');loadScript('/k8s-book/en.search-data.min.7e22730387e11cd99a8dcb54f505447f8bef3cf5241a3795da34643ff7e963c4.js',function(){input.required=false;search();});}
