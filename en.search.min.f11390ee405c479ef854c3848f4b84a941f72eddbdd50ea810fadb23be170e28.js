...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s-book/flexsearch.min.js');loadScript('/k8s-book/en.search-data.min.f7c58770337a4ea352ee64c1b4d2cbd72e434a32dd5c37d649aaea4e6a0841f9.js',function(){input.required=false;search();});}
