...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s-book/flexsearch.min.js');loadScript('/k8s-book/en.search-data.min.06b6b7dd45c26b8a9e2705ce4f08a8dc72daa2dea91876a2cc750cedf90e3d75.js',function(){input.required=false;search();});}
