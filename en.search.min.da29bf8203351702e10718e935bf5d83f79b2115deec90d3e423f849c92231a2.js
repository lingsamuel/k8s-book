...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s-book/flexsearch.min.js');loadScript('/k8s-book/en.search-data.min.febb77298add76d6adcae641c8c18e58d2dadf9f73b77aa1a52a70ae71b27694.js',function(){input.required=false;search();});}
