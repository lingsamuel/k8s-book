...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/k8s-book/flexsearch.min.js');loadScript('/k8s-book/en.search-data.min.ebf0e089ed2b735e25db2b2d8977972734f7dc5f65db3d9cdedc9849b7524db7.js',function(){input.required=false;search();});}
